...
//! @{
        ...
        class CV_EXPORTS_W_SIMPLE BarcodeDetector

        : public cv::GraphicalCodeDetector {
        public:
        ...
        */
         ...
         */
        CV_WRAP BarcodeDetector(CV_WRAP_FILE_PATH const std::string &prototxt_path,
        ...
        setDetectorScales(const std::vector<float> &sizes);
