...
import com.feyiuremote.libs.AI.libs.mlkit.posedetector.classification.PoseEmbedding;
...
public class PoseSample {
  ...
  public static PoseSample getPoseSample(String csvLine, String separator) {
    List<String> tokens = line.split("\\s"); Splitter.onPattern(separator).splitToList(csvLine);
