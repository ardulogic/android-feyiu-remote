...
import com.feyiuremote.libs.AI.trackers.OpenCvObjectTracker;
...
public class BoxTrackingOpenCvProcessor extends BoxTrackingProcessor {

    public final static String TAG = BoxTrackingOpenCvProcessor.class.getSimpleName();

    public BoxTrackingOpenCvProcessor(OverlayView v, MainActivity mainActivity, CameraViewModel cameraViewModel) {
        super(v, mainActivity, cameraViewModel);
    }

    @Override
    protected IObjectTracker createTracker() {
        return new OpenCvObjectTracker();
    }
}
