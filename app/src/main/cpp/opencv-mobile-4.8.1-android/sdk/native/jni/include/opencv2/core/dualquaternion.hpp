 ...
 */
    ...
    public:
         ...
         */
        DualQuat(const _Tp w, const _Tp x, const _Tp y, const _Tp z, const _Tp w_, const _Tp x_,
                 const _Tp y_, const _Tp z_);
        ...
        */
         ...
         * @sa Quat
         */
        static DualQuat<_Tp> createFromAngleAxisTrans(const _Tp angle, const Vec<_Tp, 3> &axis,
         ...
         * a dual quaternion which translation is applied before rotation.
         */
        static DualQuat<_Tp> createFromPitch(const _Tp angle, const _Tp d, const Vec<_Tp, 3> &axis,
        ...
        template<typename T>
        friend DualQuat<T>
        power(const DualQuat<T> &p, const DualQuat<T> &q, QuatAssumeType assumeUnit);
         ...
         */
        DualQuat<_Tp>
        power(const DualQuat<_Tp> &q, QuatAssumeType assumeUnit = QUAT_ASSUME_NOT_UNIT) const;
